...
def get_settings() -> Dict:
    ...
    if jazzmin_settings["search_model"]:
        ...
        for search_model in jazzmin_settings["search_model"]:
            ...
            if model_meta:
                jazzmin_search_model["search_name"] = (
                    model_meta.verbose_name_plural.title()
                )
            else:
    ...
    jazzmin_settings["site_icon"] = (
        jazzmin_settings["site_icon"] or jazzmin_settings["site_logo"]
    )

    # Default the login logo using the site logo
    jazzmin_settings["login_logo"] = (
        jazzmin_settings["login_logo"] or jazzmin_settings["site_logo"]
    )

    # Default the login logo dark using the login logo
    jazzmin_settings["login_logo_dark"] = (
        jazzmin_settings["login_logo_dark"] or jazzmin_settings["login_logo"]
    )
